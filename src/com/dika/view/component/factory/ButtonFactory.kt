...
object ButtonFactory: Factory<Button>() {
    ...
    val firstPageButton get() = create("Halaman Pertama", SmallIconRes.firstPageIcon)
    val lastPageButton get() = create("Halaman Terakhir", SmallIconRes.lastPageIcon)
    val loginButton get() = create("Login", SmallIconRes.loginIcon)
    val logoutButton get() = create("Logout", SmallIconRes.logoutIcon)
    val nextButton get() = create("Selanjutnya", SmallIconRes.nextIcon)
    val previousButton get() = create("Sebelumnya", SmallIconRes.previousIcon)
    val printButton get() = create("Cetak", SmallIconRes.printIcon)
    val refreshButton get() = create("Segarkan", SmallIconRes.refreshIcon)
